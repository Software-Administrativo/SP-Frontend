<template>
    <div class="q-py-sm table-container">
      ...
      <div class="container-content">
        <ButtonAdd @onClick="clickButton" label="Crear nuevo gasto de actividad" />
  ...
  async function updateDataActivityExpense() {
    ...
    try {
      ...
      isLoading.value = false;
      showNotification("positive", "Gasto de actividad actualizado correctamente");
      modal.toggleModal();
      rows.value = [];
      getDataActivityExpenses();
    } catch {
  ...
  async function inactiveActivityExpenseCosts(id) {
    ...
    try {
      ...
      loading.value = false;
      showNotification("positive", "Gasto de actividad desactivado correctamente");
      rows.value = [];
      inactiveRows.value = [];
      getDataActivityExpenses();
    } catch (error) {
