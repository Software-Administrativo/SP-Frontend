<template>
    <div class="q-py-sm table-container">
      ...
      <div class="container-content">
        <ButtonAdd @onClick="clickButton" label="Crear nuevo gasto administrativo" />
  ...
  async function postDataAdminExpense() {
    ...
    try {
      ...
      showNotification("positive", "Gasto administrativo registrado correctamente");
      modal.toggleModal();
      rows.value = [];
  ...
  async function updateDataAdminExpense() {
    ...
    try {
      ...
      isLoading.value = false;
      showNotification("positive", "Gasto administrativo actualizado correctamente");
      modal.toggleModal();
      rows.value = [];
      getDataAdminExpenses();
    } catch {
  ...
  async function inactiveAdminExpenseCosts(id) {
    ...
    try {
      ...
      loading.value = false;
      showNotification("positive", "Gasto administrativo desactivado correctamente");
      rows.value = [];
      inactiveRows.value = [];
      getDataAdminExpenses();
    } catch (error) {
